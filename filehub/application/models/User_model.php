...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.firstName, BaseTbl.lastName, BaseTbl.mobile, BaseTbl.createdDtm, Role.role');
    ...
    function users($searchText = '', $page, $segment, $role)
    {
        ...
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.roleId, BaseTbl.firstName, BaseTbl.lastName, BaseTbl.mobile, BaseTbl.createdDtm, Role.role');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Role', 'Role.roleId = BaseTbl.roleId','left');
        $this->db->where('BaseTbl.isDeleted', 0);
        $this->db->where('BaseTbl.roleId', $role);
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.pmtType, BaseTbl.pmtAccount, BaseTbl.refCode, BaseTbl.firstName, BaseTbl.lastName, BaseTbl.mobile, BaseTbl.roleId, Roles.role');
        $this->db->from('tbl_users as BaseTbl');
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.refCode, BaseTbl.firstName, BaseTbl.lastName, BaseTbl.mobile, BaseTbl.roleId, Roles.role');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Roles','Roles.roleId = BaseTbl.roleId');
