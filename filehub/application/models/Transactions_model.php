...
class Transactions_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.id, BaseTbl.referrerId, User.firstName, BaseTbl.referredId, BaseTbl.interest, BaseTbl.createdDtm');
     ...
     */
    function addNewDeposit($userId, $depositInfo, $earningsAmount, $start, $end, $payoutsInterval, $maturity)
    {
        $this->db->trans_start();
        ...
        if($result > 0)
        {
            ...
            {
                $dates = $this->getDatesFromRange($start, $end, $payoutsInterval);
    ...
    function updateDeposit($userId, $depositId, $depositInfo, $earningsAmount, $start, $end, $payoutsInterval, $maturity)
    {
        $this->db->trans_start();
