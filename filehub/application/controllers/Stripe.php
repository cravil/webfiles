    ...
    */
    public function index()
    {
        ...
        } else
        {
            ...
            $this->global['breadcrumbs'] = 'Deposits'.' <span class="breadcrumb-arrow-right"></span> '.'Stripe';
    ...
    */
    public function stripePost()
    {
        ...
        if ($success!=1)
        {
            ...
            //Add the deposit
            $result = $this->transactions_model->addNewDeposit($this->vendorId, $depositInfo, $earningsAmount, $startDate, $endDate, $payoutsInterval, $maturityPeriod);
            ...
            if($result > 0)
            {
                ...
                $this->session->set_flashdata('error', 'Error in depositing the funds to your account');
            }
    ...
    function success()
    {
        ...
        if($success)
        {
            ...
            $this->global['displayBreadcrumbs'] = true;
            $this->global['breadcrumbs'] = 'Payments'.' <span class="breadcrumb-arrow-right"></span> '.'Stripe';
