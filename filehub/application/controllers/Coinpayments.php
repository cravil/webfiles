       ...
       if(!$_SESSION['DepositAmount'])
       {
        ...
        } else
        {
            ...
            */
            ...
            //Let's generate the QR Code Here
            $this->load->library('ciqrcode');
            $params['data'] = $res['result']['address'];
            $params['level'] = 'H';
            $params['size'] = 4;
            ...
            $this->global['breadcrumbs'] = 'Deposits'.' <span class="breadcrumb-arrow-right"></span> '.'Crypto';
    ...
    function checkCoinPayments($invoice)
    {
        ...
        else
        {
            ...
            if($status == '0')
            {
                $array = array(
                    'success' => false,
                    'msg' => html_escape('Pending payment')
                );
            ...
            else if($status == '1')
            {
                $array = array(
                    'success' => true,
                    'msg' => html_escape("Your payment of $paymentInfo->amount2.$paymentInfo->method is succesful")
                );
