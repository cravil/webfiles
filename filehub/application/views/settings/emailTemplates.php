        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    <h1 class="dt-page__title text-white display-i">Email Templates</h1>
                        ...
                        <div class="dt-module">
                            ...
                            <div class="dt-module__sidebar">
                                ...
                                <div class="dt-module__sidebar-header border-bottom">
                                    <div class="d-none d-md-flex align-items-center">
                                        ...
                                        <span class="h3 mb-0">Templates</span>
                                    </div>
                            ...
                            <div class="dt-module__container">
                                ...
                                <div class="dt-module__header d-none d-md-flex">
                                    <span for="h3 mb-0 mr-1m font-1-2m">Subject:</span>
                                ...
                                <div class="dt-module__content ps-custom-scrollbar ps">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="dt-card__body">
                                            ...
                                            <button type="submit"
                                                class="btn btn-info text-uppercase w-100" id="edit_email">Save & Update</button>
                                        </div>
                                        <!-- /card body -->
                                    </div>
                                    <!-- /module content inner -->
