        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    <h1 class="dt-page__title text-white display-i">Plans</h1>
                    <!-- Check the access for this component -->
                    <?php if($this->user_model->getPermissions('plans', 'add', $userId) OR $role == ROLE_ADMIN) {?>
                    <a href="<?php echo base_url(); ?>plans/new" class="btn btn-light btn-sm display-i ft-right">Create Plan</a>
                    <?php }?>
                ...
                <div class="row">
                    ...
                    ?>
                                                <tr id="row<?php echo $plan->id ?>">
                                                    ...
                                                    <td><?php $val = $plan->principalReturn == 1 ? 'Yes' : 'No'; echo $val ?>
                                                    </td>
                                                    ...
                                                    <?php if($this->user_model->getPermissions('plans', 'edit', $userId) OR $role == ROLE_ADMIN) {?>
                                                        <a class="btn btn-sm btn-info"
                                                            ...
                                                            title="Edit">Edit</a>
                                                        <button class="btn btn-sm btn-danger deleteUser" id="deletebutton<?php echo $plan->id ?>" value="<?php echo $plan->id ?>" data-toggle="modal" data-target="#deleteModal">Delete</button>
                                                    <?php }?>
                                                    </td>
                                                </tr>
                                                <?php }?>
