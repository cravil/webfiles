                            ...
                            <div class="dropdown mt-2">
                                ...
                                <a href="<?php echo base_url().'clients/editClient/'.$targetId; ?>"
                                    ...
                                    <i class="icon icon-settings icon-xl mr-2"></i><span
                                        class="d-none d-sm-inline-block">Edit Account</span>
                                </a>
                                <!-- /dropdown button -->
                                <?php }?>
